...
import io.nikhilcode.omdb.Utils.CommonUtils;
import io.nikhilcode.omdb.Services.RetrofitLoader;
import io.nikhilcode.omdb.Services.searchService;
   ...
   // private EditText mSearchEditText;
    ...
    public void startSearch() {
        if(CommonUtils.isNetworkAvailable(getApplicationContext())) {
            ...
            String movieTitle = movie_name.trim();
